...
1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/esder7709/kocom.py 를 입력한 다음 ADD 버튼을 누릅니다.
...
(2024-03-12 수정) python3 -m pip install typing_extensions 추가
